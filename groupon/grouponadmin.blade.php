					  ...
					  <div class="container">
					     ...
					     <div class="form-group">
					        ...
					        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              ...
                              <input type="text" name="title" size="33"></div></div><BR>
					          ...
					          <input type="text" name="categ" size="33"></div></div></div>
                	          <br><br>
                	          <div class="form-group">
				       		  <div class="col-md-offset-6">
					          ...
					          <input type="submit" value="upload" class="btn  btn-danger" onclick="upload()"></div>
	                          </div>
